...
public class CardsController : Controller
{
    ...
    [HttpGet("GetAllWithCardTypeAndUser")]
    public IActionResult GetAllWithCardTypeAndUser()
    {
        return Ok(_cardRepository.GetAll(include: card => card.Include(c => c.CardType).Include(c=>c.User)));
    }
